    ...
    public class WeChatLogin
    {
        ...
        public static bool ExecLogin(string name, string pass)
        {
            ...
            try
            {
                ...
                webRequest2.Referer = "http://mp.weixin.qq.com/cgi-bin/loginpage?lang=zh_CN&t=wxm2-login";
                ...
                //此处用到了newtonsoft来序列化
                WeChatRetInfo retinfo = JsonConvert.DeserializeObject<WeChatRetInfo>(text2);
