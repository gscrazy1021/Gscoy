...
namespace Gscoy.WeChat.Biz
{
    ...
    {
        public static List<WeChatUserInfoModel> SubscribeMP()
        {
            ...
            try
            {
                ...
                cookie = WeChatLogin.LoginInfo.LoginCookie;//取得cookie
                token = WeChatLogin.LoginInfo.Token;//取得token
                ...
                List<WeChatUserInfoModel> wxlist = JsonConvert.DeserializeObject<List<WeChatUserInfoModel>>(textresult);
